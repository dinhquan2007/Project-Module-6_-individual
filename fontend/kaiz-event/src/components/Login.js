            ...
            <div className="limiter">
                <div className="container-login100">
                    <div className="wrap-login100"
                         style={{backgroundImage: "url(https://www.shutterstock.com/shutterstock/photos/424227082/display_1500/stock-vector-vector-of-music-symbol-or-icon-music-headphones-music-studio-logo-music-poster-424227082.jpg)"}}>
                        <div className="login100-pic js-tilt">
                        </div>
                        <Form style={{color: "white"}} className="login100-form validate-form" name='f'
                              method='post'>
					<span className="login100-form-title" style={{color: "blue",fontSize:"30px"}}>
						Đăng nhập
					</span>
